...
class personal_information(models.Model):
    ...
    InternID = models.IntegerField(primary_key=True, null=False)
    ...
    Documents = models.FileField(upload_to='uploads/', null=True, blank=True)
...
class internship_history(models.Model):
    HistoryID = models.IntegerField(primary_key=True, default="1")
    ...
    Paid_Period = models.CharField(max_length=50)
    Stipend_cost_per_month = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    Accomodation_cost_per_month = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    Air_Fare = models.DecimalField(max_digits=8, decimal_places=2, null=True)
...
class qualifications_on_entry(models.Model):
    QualificationID = models.IntegerField(primary_key=True, default="1")
    InternID = models.ForeignKey('personal_information', on_delete=models.CASCADE)
    ...
    Level_Attained = models.CharField(max_length=50, null=True)
    Year_Attained = models.CharField(max_length=50, blank=True)
    Grade = models.CharField(max_length=50, blank=True)
    Experience = models.CharField(max_length=200, blank=True)


    def __str__(self):
        return self.Level_Attained
...
class employment_history(models.Model):
    ...
    Job_Step= models.CharField(max_length=50, null=True, blank=True)   
    Start_date = models.DateField(null=True, blank=True)
...
class employee_degrees(models.Model):
    ...
    PastEmployeeID = models.ForeignKey('past_employees', on_delete=models.CASCADE)
    Degree_Acronym = models.CharField(max_length=100, null=True)
